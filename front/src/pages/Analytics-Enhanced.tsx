                      ...
                      <ComposedChart data={weightProgress}>
                        ...
                        <Tooltip 
                          ...
                          formatter={(value, name) => [
                            `${value} ${name === 'weight' ? 'kg' : name === 'bmi' ? 'BMI' : '%'}`,
                            name === 'weight' ? 'Weight' : name === 'bmi' ? 'BMI' : 'Body Fat'
                          ]}
                        />
                          ...
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center' }}>
                              ...
                              <Chip
                                ...
                                size="small"
                                color={item.change > 0 ? (item.metric === 'Body Fat' ? 'error' : 'success') : 
                                       item.change < 0 ? (item.metric === 'Body Fat' ? 'success' : 'error') : 'default'}
                            ...
                            <LinearProgress
                              ...
                              sx={{ 
                                ...
                                '& .MuiLinearProgress-bar': {
                                  borderRadius: 4,
                                  backgroundColor: goal.progress > 90 ? '#4caf50' : goal.progress > 70 ? '#2196f3' : '#ff9800'
                                }
                              }}
                            />
                    ...
                    <ResponsiveContainer width="100%" height={350}>
                      <ComposedChart data={caloriesData}>
                        ...
                        <Tooltip 
                          ...
                          formatter={(value, name) => [
                            `${value} cal`,
                            name === 'burned' ? 'Burned' : name === 'consumed' ? 'Consumed' : 'Deficit'
                          ]}
                        />
                    ...
                    <ResponsiveContainer width="100%" height={350}>
                      <ComposedChart data={sleepRecovery}>
                        ...
                        <Tooltip 
                          labelFormatter={(date) => new Date(date).toLocaleDateString()}
                          formatter={(value, name) => [
                            `${value} ${name === 'sleep' ? 'hours' : '%'}`,
                            name === 'sleep' ? 'Sleep Duration' : name === 'quality' ? 'Sleep Quality' : 'Recovery Score'
                          ]}
                        />
